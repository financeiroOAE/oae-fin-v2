...
<InfoTooltip title="Receita Administrativa Vinculada" content="Receita administrativa vinculada aos projetos selecionados." />
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1.5rem', marginBottom: '2rem' }}>
        ...
        <div className="card" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', width: '100%' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            ...
            <InfoTooltip title="Progresso de Contrato" content="Valor contratado, faturado e saldo dos projetos exibidos." />
          </div>
      ...
      <div className="card" style={{ padding: 0, overflow: 'hidden', marginBottom: '1rem' }}>
        <div className="projects-executive-table-wrap">
          <table className="projects-executive-table" style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed' }}>
            ...
            <tbody style={{ fontSize: '13px' }}>
              ...
              {paginatedProjetos.length === 0 && (
                <tr><td colSpan={11} style={{ padding: '2rem', textAlign: 'center', color: 'var(--text-secondary)', fontSize: '13px' }}>Nenhum projeto encontrado com os filtros aplicados.</td></tr>
              )}
            </tbody>
          </table>
        </div>
          ...
          <div style={{ width: '100%', maxWidth: '1000px', height: '100%', backgroundColor: 'var(--bg-main)', borderLeft: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', boxShadow: '-10px 0 30px rgba(0,0,0,0.5)', animation: 'slideIn 0.3s ease-out' }}>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '1.5rem' }}>
              ...
              <div style={{ background: 'var(--bg-main)', border: '1px solid var(--border-color)', borderRadius: '8px' }}>
                <DataTable data={selectedProjectReportMoves} />
              </div>
            </div>
          </div>
        </div>
